...
(cl:in-package laser_scan_matcher-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laser_scan_matcher-msg:<Num> is deprecated: use laser_scan_matcher-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_scan_matcher-msg:num-val is deprecated.  Use laser_scan_matcher-msg:num instead.")
  (num m))
